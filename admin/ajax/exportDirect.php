...
$sql = "select c.*, ls.sourceName, lst.statusName, lt.typeName"
     ...
     . " where c.leadType=lt.typeID and c.leadSource=ls.sourceID and c.istatus=lst.id"
...
$columns = array(
         ...
         $siteSettings->enddate,
         $siteSettings->weightage,
         $siteSettings->marksobtained,
         $siteSettings->totalmarks,
         'Source',
         'Type',
         'Status',
...
foreach ($contacts as $key => $val) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $val->subject);
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $val->startdate);
    ...
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $row, $val->enddate);
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $row, $val->weightage);
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $row, $val->marksobtained);
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13, $row, $val->totalmarks);
