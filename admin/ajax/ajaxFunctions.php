    ...
    switch ($post['type']) {
        ...
        case 'editLead':
            ...
            $sql = "select c.*, ls.sourceName, lt.typeName, lst.statusName, u.first, u.last"
                 ...
                 . " {$dbPre}users u"
                 . " where c.id='$leadID' and c.leadSource=ls.sourceID and c.leadType=lt.typeID and c.istatus=lst.id"
            ...
            if ($invalid == true) {
                ...
                if ($existing == 'existing') {          // Existing Lead update
                    ...
                    $vals = array(
                        ...
                        'totalmarks'            => $post['zipCode'],
                        'enddate'           => $post['city'],
                        'weightage'          => $post['state'],
                        'marksobtained'        => $post['country'],
                        'leadSource'     => $post['leadSource'],
                        'leadType'       => $post['leadType'],
                        'istatus'        => $post['leadStatus'],
