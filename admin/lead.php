...
$sql = "select c.*, ls.sourceName, lt.typeName, lst.statusName from {$dbPre}contacts c, {$dbPre}leadStatus lst"
     . ", {$dbPre}leadSource ls, {$dbPre}leadType lt where c.id='$leadID' and c.istatus=lst.id"
  ...
  <div class="individualDiv">
    <div class="leadDetails">
      ...
      <table class="individualLead">
        ...
        <tr class="trClass1"><td class="leadLabel"><?php echo $siteSettings->enddate; ?>:</td>
            <td class="leadData"><?php echo html_entity_decode($lead->enddate); ?></td></tr>
        <tr class="trClass0"><td class="leadLabel"><?php echo $siteSettings->weightage; ?>:</td>
            <td class="leadData"><?php echo html_entity_decode($lead->weightage); ?></td></tr>
        <tr class="trClass1"><td class="leadLabel"><?php echo $siteSettings->marksobtained; ?>: </td>
            <td class="leadData"><?php echo html_entity_decode($lead->marksobtained); ?></td></tr>
        <tr class="trClass1"><td class="leadLabel"><?php echo $siteSettings->totalmarks; ?>: </td>
            <td class="leadData"><?php echo html_entity_decode($lead->totalmarks); ?></td></tr>
        ...
        <tr class="trClass1"><td class="leadLabel"><?php echo $siteSettings->subject; ?>: </td>
            <td class="leadData"><?php echo html_entity_decode($lead->subject); ?></td></tr>
        <tr class="trClass0"><td class="leadLabel"><?php echo $siteSettings->startdate; ?>: </td>
            <td class="leadData"><?php echo html_entity_decode($lead->startdate); ?></td></tr>
