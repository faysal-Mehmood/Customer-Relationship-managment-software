// config.js corresponds to config.php file (configuration or settings page)
    ...
    $(document).on('click', '.addNewUser', function() {  // Add a new user
        var content = '<h3 class="modalH">Add a new user</h3><fieldset><legend>Create User</legend>'
                    ...
                    + 'Manager: <input type="radio" class="User" value="2" name="role">&nbsp;&nbsp;&nbsp;&nbsp;'
                    + 'Teacher: <input type="radio" class="teacher" value="3" name="role">&nbsp;&nbsp;&nbsp;&nbsp;'
                    + 'Student: <input type="radio" class="ReadOnly" value="0" name="role"></td>'
                    + '</tr>'
            ...
            success: function(response) {
                if (response.result == '1') {
                    ...
                    if (isAdmin == '1') {
                        ...
                        var roleText = 'Manager';
                    } else if (isAdmin == '0') {
                        var roleText = 'Read Only';
                    }
                    else if (isAdmin == '3') {
                        var roleText = 'Teacher';
                    }
                    ...
                    if(typeof(data.error) != 'undefined') {
                        if(data.error == '1') {
                            ...
                            var output = '<p><b>Step 2.</b> Align your Data:</p>'
                                     ...
                                     + '<tr><td>' + siteSettings.subject + '</td></tr>'
                                     + '<tr><td>' + siteSettings.startdate + '</td></tr>'
                                     + '<tr><td>Primary Email</td></tr>'
                                     + '<tr><td>Other Email 1</td></tr>'
                                     + '<tr><td>Other Email 2</td></tr>'
                                     + '<tr><td>Other Email 3</td></tr>'
                                     + '<tr><td>' + siteSettings.enddate + '</td></tr>'
                                     + '<tr><td>' + siteSettings.weightage + '</td></tr>'
                                     + '<tr><td>' + siteSettings.marksobtained + '</td></tr>'
                                     + '<tr><td>' + siteSettings.totalmarks + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField1 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField2 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField3 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField4 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField5 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField6 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField7 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField8 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField9 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField10 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField11 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField12 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField13 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField14 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField15 + '</td></tr>'
                                     + '<tr><td>' + siteSettings.customField16 + '</td></tr>'
                                     + '<tr><td>Notes</td></tr>'
                                     + '</table>'
                            ...
                            $.each(data.topRow, function(n, val) {
                               ...
                               // var id = $('.matchData tr:eq(i) td:eq(4)').html()
